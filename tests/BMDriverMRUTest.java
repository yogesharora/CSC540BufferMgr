...
public class BMDriverMRUTest extends TestDriver implements GlobalConst {
	 ...
	 */
	public BMDriverMRUTest() {
		super("Buffer Manager");
	}

	public void initBeforeTests() {
		try {
			SystemDefs.initBufMgr(new BufMgr(NUMBUF,"bufmgr.MRU"));
		} catch (Exception ire) {
			ire.printStackTrace();
			System.exit(1);
		}
	...
	public static void main(String argv[]) {
		...
		BMDriverMRUTest bmt = new BMDriverMRUTest();
